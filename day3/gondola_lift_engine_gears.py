from engine_gear_func import (is_digit, gather_all_symbols, is_symbol, find_positions_of_all_true_cell,
                              is_neighbor_symbol, extract_value_from_part_number_index)
...
if __name__ == '__main__':
    ...
    all_part_numbers = set(all_part_numbers)
